 ...
 * </copyright>
 *
 * $Id: XSDModelGroupDefinitionImpl.java,v 1.12.2.2 2008/12/15 18:22:27 davidms Exp $
 */
        ...
        if (parent != null)
        {
          ...
          if (parent instanceof XSDRedefine)
          {
            ...
            if (redefinedSchema != null)
            {
              ...
              {
                XSDComponent replacement = (XSDComponent)redefinitionMap.get(newResolvedModelGroupDefinition);
                if (replacement != null)
                {
